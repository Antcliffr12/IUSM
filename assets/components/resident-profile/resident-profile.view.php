...
$data_get_resident_title = $profile->getResidentTitle();
...
$trainingDesc = isset($profile->trainingDesc) ? $profile->trainingDesc : '';
	...
	<div class="summary bg-iu-dark-midnight">
		...
		<div class="text center-contents-vertically">
			<span>
				...
				<h1><?=$title?> <?= $profile->highdegree ?> </h1>
				<div class="positions">
                	<h3><?= $trainingDesc ?></h3>
				</div>

				<div class="school">
					<h3><?= $profile->fromSchool ?></h3>
				</div>
