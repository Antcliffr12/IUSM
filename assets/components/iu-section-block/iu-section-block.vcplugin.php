...
function sc_iu_section_block( $atts, $content = '' ) {
	...
	return render_component('iu-section-block', [
		'classes' => implode(' ', $classes),
		'container_mode' => $container_mode,
	    'processed_content' => $processed_content,
	]);
}
add_shortcode( 'iu_section_block', 'sc_iu_section_block' );

if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	class WPBakeryShortCode_IU_Section_Block extends WPBakeryShortCodesContainer {}
}
if( function_exists('vc_map')) {
	vc_map(array(
		'name' => __('Section Block'),
		'base' => 'iu_section_block',
		'is_container' => true,
