<div id="news-campuses" data-selectedcampus="Bloomington" data-component="Campuses">
	<h1><?= $title ?></h1>
	<div class="row">
		...
		<div class="col-md-4 campus-links">
			...
			<div class="clearfix list-wrapper">
					...
					<ul class="menu">
						<li><a class="active" data-campus="Bloomington" href="/campuses/bloomington/news-events/" aria-describedby="bloomington">Bloomington</a></li>
						<li><a data-campus="Evansville" href="/campuses/evansville/news-events/" aria-describedby="evansville">Evansville</a></li>
						<li><a data-campus="Fort Wayne" href="/campuses/fort-wayne/news-events/" aria-describedby="fort-wayne">Fort Wayne</a></li>
						<li><a data-campus="Gary" href="/campuses/gary/news-events/" aria-describedby="gary">Gary</a></li>
						<li><a data-campus="Indianapolis" href="/campuses/indianapolis/news-events/" aria-describedby="indianapolis">Indianapolis</a></li>
					</ul>
					<ul class="menu">
						<li><a data-campus="Muncie" href="/campuses/muncie/news-events/" aria-describedby="muncie">Muncie</a></li>
						<li><a data-campus="South Bend" href="/campuses/south-bend/news-events/" aria-describedby="south-bend">South Bend</a></li>
						<li><a data-campus="Terre Haute" href="/campuses/terra-haute/news-events/" aria-describedby="terre-haute">Terre Haute</a></li>
						<li><a data-campus="West Lafayette" href="/campuses/west-lafayette/news-events/" aria-describedby="west-lafayette">West Lafayette</a></li>
					</ul>
		...
		<div class="col-md-4 campus-detail">
			...
			<div id="gary" data-campus="Gary" class="active">
