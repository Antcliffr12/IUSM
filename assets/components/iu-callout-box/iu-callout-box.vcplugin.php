...
function sc_iu_callout_box($atts, $content = '') {
	...
	return render_component('iu-callout-box', [
		'title' => $title,
		'body' => $content,
		'buttons' => $buttons,
...
add_shortcode('iu_callout_box', 'sc_iu_callout_box');

if ( class_exists( 'WPBakeryShortCode' ) ) {
	class WPBakeryShortCode_IU_Callout_Box extends WPBakeryShortCode {}
}
