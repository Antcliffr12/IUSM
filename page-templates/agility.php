...
<h1><h1 class="newsheadline"><?= $title ?></h1></h1>
...
<h5>
    <font face="Arial, Helvetica, sans-serif"><td bgcolor="#F2F2F2" bordercolor="#999999">
            <center>
            ...
            <p><font face="Arial, Helvetica, sans-serif" size="2"><a href="<?= $image_url ?>" title="<?= $caption ?>">Download print quality image</a></font></p><br/><hr/>
        </td>
    </font>
</h5>
...
<div class="nr-media-contact-wrap"><font face="Arial, Helvetica, sans-serif" size="2">
        <font face="Arial, Helvetica, sans-serif" size="2">
...
<div id="hide-footer">
<tr>
<td align="center" style="padding:17px 0 0 0;" valign="top"><a href="[%SUBSCRIPTION_COMMON_TRACKING_LINK%]" style="color:#990000; text-decoration:none; font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:normal;">Unsubscribe</a>
</td>
</tr>
</div>
